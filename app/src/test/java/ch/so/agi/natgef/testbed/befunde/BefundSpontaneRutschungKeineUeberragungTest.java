...
public class BefundSpontaneRutschungKeineUeberragungTest extends TestBase {
    @Test
    public void checkConstraint() {
        String constraintName = "SO_AFU_Naturgefahren_20230802.Befunde.BefundSpontaneRutschung.CheckBefundSpontaneRutschungKeineUeberragung";
