...
public class BefundSteinBlockschlagTest extends TestBase {
    @Test
    public void checkConstraint() {
        String constraintName = "SO_AFU_Naturgefahren_20230802.Befunde.PQ_Jaehrlichkeit_SteinBlockschlag__Prozessquelle.CheckBefundSteinBlockschlag";
